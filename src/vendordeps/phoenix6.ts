    ...
    conflictsWith: [
        {
            ...
            errorMessage:
                "The combined Phoenix-6-And-5 vendordep is no longer supported. Please remove the vendordep and instead add both the latest Phoenix 6 vendordep and Phoenix 5 vendordep.",
    ...
    cppDependencies: [
        {
            ...
            sharedLibrary: true,
            skipInvalidPlatforms: true,
            binaryPlatforms: ["windowsx86-64", "linuxx86-64", "linuxathena"],
            simMode: "hwsim",
        },
        {
            groupId: "com.ctre.phoenix6",
        ...
        },
        {
            ...
            sharedLibrary: true,
            skipInvalidPlatforms: true,
            binaryPlatforms: ["windowsx86-64", "linuxx86-64", "osxuniversal"],
            simMode: "swsim",
        },
        {
            groupId: "com.ctre.phoenix6.sim",
